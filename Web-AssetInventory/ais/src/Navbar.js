        ...
        <div className="collapse navbar-collapse justify-content-center" id="navbarNav" >
            <ul className="navbar-nav justify-content-center text-center align-items-center">
                ...
                <li className="nav-item mx-5">
                    <button className="btn btn-primary lightBlueButton my-3" href="#" onClick={handleSignInClick}>Search</button>
                </li>
                <li className="nav-item mx-5">
                    <button className="btn btn-primary lightBlueButton my-3" href="#" onClick={handleSignInClick}>Scan</button>
                </li>
            </ul>
        </div>
    </nav>);
