...
export default function SearchPageItemBar({handleRemove , handleAdd, handleSearch}){
        ...
        <div className="collapse navbar-collapse justify-content-end" id="navbarSearch">
            <ul className="navbar-nav justify-content-center text-center">
                <li className="nav-item active mx-5 justify-content-center">
                    <button className="btn btn-primary addRemoveButton my-3" href="#" onClick={handleSearch}>Search</button>
                </li>
                <li className="nav-item active mx-5 justify-content-center">
