...
export default function InstructionPage({username, handleSearch, handleSignOut, handleScanPage}){
    return(

        <div className="">
            
            <div className="container-fluid align-items-center justify-content-center instructionPageBackground">
                <div className="row d-flex justify-content-center"><Navbar username={username} handleSearch={handleSearch} handleSignOut={handleSignOut} handleScanPage={handleScanPage}></Navbar></div>
